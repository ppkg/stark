...
// HttpWrapHandler wraps swaggerFiles.Handler and returns unc(ctx web.Context)
var WrapHandler = HttpWrapHandler()

// HttpWrapHandler wraps `http.Handler` into `unc(ctx web.Context)`.
func HttpWrapHandler(configFns ...func(c *Config)) func(ctx web.Context) {
	var once sync.Once
	...
	return func(ctx web.Context) {
		...
		switch path {
		case "":
			ctx.Redirect(301, h.Prefix+"index.html")
		case "index.html":
